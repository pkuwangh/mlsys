...
export CPATH="${BOOST_PATH}/include:${CUDA_PATH}/include:${CPATH}"
export LIBRARY_PATH="${BOOST_PATH}/lib64:${CUDA_PATH}/lib64:${LIBRARY_PATH}"
export LD_LIBRARY_PATH="${BOOST_PATH}/lib64:${CUDA_PATH}/lib64:${LD_LIBRARY_PATH}"
