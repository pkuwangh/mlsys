...
#define E09_BN 256
#define E09_BK 64
#define E09_BLOCK_SIZE 128*3
#define E09_QSIZE 3
#define E09_CLUSTER_M 2
#define E09_CLUSTER_N 1
#define E09_NUM_SM 128
...
matmul_e09_no_memset(const __grid_constant__ CUtensorMap tensorMapA, const __grid_constant__ CUtensorMap tensorMapB, bf16 *C, int M, int N, int K) {
...
template <typename Kernel> void _run_kernel(MatmulBuffers &buffers, Kernel kernel, bool check_error) {
    CUtensorMap tma_map_A = create_tensor_map<E09_BM, E09_BK>(buffers.dA_bf16, buffers.M, buffers.K);
    CUtensorMap tma_map_B = create_tensor_map<E09_BN, E09_BK>(buffers.dB_bf16_t, buffers.N, buffers.K);

    size_t shmem_size = sizeof(SMem<E09_BM, E09_BN, E09_BK, E09_QSIZE>);
...
void runMatmulE09NoMemset(MatmulBuffers &buffers) {
    constexpr int TM = 16;
    constexpr int TN = 8;
